...
def add_args(parser):
    ...
    parser.add_argument(
        '-o', '--outdir', help='Output directory for analysis results (default: [workdir]/analyze.[epoch])'
    )
    ...
    group.add_argument(
        '--pc', type=int, default=2, help='Number of principal component traversals to generate (default: %(default)s)'
    )
    group.add_argument(
        '--ksample', type=int, default=20, help='Number of kmeans samples to generate (default: %(default)s)'
    )
    group.add_argument(
        '--vol-start-index',
        type=int,
