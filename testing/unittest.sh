...
cryodrgn eval_image sdata/toy_projections.mrcs output/toy_recon_vae/weights.pkl -c output/toy_recon_vae/config.pkl -o output/toy_recon_vae/test.pkl --poses data/toy_angles.pkl
