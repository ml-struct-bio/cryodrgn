...
python ../utils/parse_ctf_star.py data/FinalRefinement-OriginalParticles-PfCRT.star -w .1 -o output/ctf1.pkl --png output/ctf1.png -D 300 --Apix 1.035
diff output/ctf1.pkl data/ctf1.pkl

# Test 2: Parse CTF from cs file
python ../utils/parse_ctf_csparc.py data/cryosparc_P12_J24_001_particles.cs -o output/ctf2.pkl --png output/ctf2.png
diff output/ctf2.pkl data/ctf2.pkl
