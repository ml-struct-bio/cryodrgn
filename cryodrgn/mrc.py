...
class MRCHeader:
    ...
    @classmethod
    def make_default_header(cls, data, is_vol=True, Apix=1.0, xorg=0.0, yorg=0.0, zorg=0.0):
        nz, ny, nx = data.shape
...
def write(fname, array, header=None, Apix=1.0, xorg=0.0, yorg=0.0, zorg=0.0, is_vol=None):
