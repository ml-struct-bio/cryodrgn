...
class TestFixedHetero:
    def get_outdir(self, tmpdir_factory, particles, poses, ctf=None, indices=None):
    ...
    def test_landscape_notebook(self, tmpdir_factory, particles, poses, ctf, indices):
        ...
        notebook_fl = "analyze-landscape.ipynb"
    ...
    def test_plot_classes(
        ...
        if plot_outdir is not None:
            ...
            use_outdir = os.path.join(outdir, "analyze.4")
        else:
...
@pytest.mark.parametrize("load_epoch", [2, 4])
