...
_ROUTES = (
    ...
    ("/volume-slice-viewer", re.volume_slice_viewer_page, "GET"),
    ("/api/explorer_volume_media", re.api_explorer_volume_media, "POST"),
    (
        "/api/volume_slice_viewer/analyze_volumes",
        re.api_volume_slice_viewer_analyze_volumes,
        "GET",
    ),
    (
        "/api/volume_slice_viewer/analyze_markers",
        re.api_volume_slice_viewer_analyze_markers,
        "GET",
    ),
    (
        "/api/volume_slice_viewer/analyze_volume",
        re.api_volume_slice_viewer_analyze_volume,
        "GET",
    ),
    (
        "/api/volume_slice_viewer/analyze_volumes_batch",
        re.api_volume_slice_viewer_analyze_volumes_batch,
        "POST",
    ),
